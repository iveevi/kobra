...
int main()
{
    ...
    // -------------------------
    Shader shader = Shader::from_source(cube_vert, cube_frag); // ("6.1.cubemaps.vs", "6.1.cubemaps.fs");
    Shader skyboxShader = Shader::from_source(sky_vert, sky_frag); // ("6.1.skybox.vs", "6.1.skybox.fs");
